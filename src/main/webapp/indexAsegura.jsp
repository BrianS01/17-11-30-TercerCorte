                    ...
                    <div class="navbar-collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <form action="Index" method="post">
                                <input style="background-color: #2a93da" class="submit" type="submit" name="cliente"  value="Cliente " onClick="value = 1" > 
                            </form>

                            
                            <p>&nbsp;</p>
                            <form action="Index" method="post">
                                <input style="background-color: #2a93da" class="submit" type="submit" name="vehiculo"  value="Vehiculo " onClick="value = 2" > 
                            </form>

                            
                            <p>&nbsp;</p>
                            <form action="Index" method="post">
                                <input style="background-color: #2a93da" class="submit" type="submit" name="siniestro"  value="Siniestro " onClick="value = 3"> 
                            </form>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-4">
                        ...
                        <p> CRECER MUCHO MUCHOTE.</p>
                    </div>
                    <div class="col-xs-12 col-md-4">
                        <div class="fa-container">
                            <i class="fa fa-bell-o fa-3x" aria-hidden="true"></i>
                        </div>
                        <h3 class="text-center">PROYECCION</h3>
                        <p> SER LOSMEJORES</p>
                    </div>
                </div>
            </div>
